...
export default [
...

  {
    ...
    start: new Date(2024, 7, 9, 8, 0, 0),
    end: new Date(2024, 7, 10, 11, 30, 0),
  },
  {
    id: 5,
    title: 'Conference',
  ...
  },
  {
    ...
    start: new Date(2024, 7, 13, 8, 0, 0),
    end: new Date(2024, 7, 13, 10, 30, 0),
  },
  {
    id: 11.1,
    title: 'Inconvenient Conference Call',
    start: new Date(2024, 7, 13, 9, 30, 0),
    end: new Date(2024, 7, 13, 12, 0, 0),
  },
  {
    id: 11.2,
    title: "Project Kickoff - Lou's Shoes",
    start: new Date(2024, 7, 13, 11, 30, 0),
    end: new Date(2024, 7, 13, 14, 0, 0),
  },
  {
    id: 11.3,
    title: 'Quote Follow-up - Tea by Tina',
    start: new Date(2024, 7, 13, 15, 30, 0),
    end: new Date(2024, 7, 13, 16, 0, 0),
  },
  {
    id: 12,
  ...
  },
  {
    id: 16,
    title: 'Video Record',
    start: new Date(2024, 7, 14, 15, 30, 0),
    end: new Date(2024, 7, 14, 19, 0, 0),
  },
  {
    id: 17,
    title: 'Dutch Song Producing',
    start: new Date(2024, 7, 14, 16, 30, 0),
    end: new Date(2024, 7, 14, 20, 0, 0),
  },
  {
    id: 18,
    title: 'Itaewon Meeting',
    start: new Date(2024, 7, 14, 16, 30, 0),
    end: new Date(2024, 7, 14, 17, 30, 0),
  },
  {
    id: 19,
    title: 'Online Coding Test',
    start: new Date(2024, 7, 14, 17, 30, 0),
    end: new Date(2024, 7, 14, 20, 30, 0),
  },
  {
    id: 20,
  ...
  },
  {
    id: 23,
    title: 'Go to the gym',
    start: new Date(2024, 7, 14, 18, 30, 0),
    end: new Date(2024, 7, 14, 20, 0, 0),
  },
  {
    id: 24,
